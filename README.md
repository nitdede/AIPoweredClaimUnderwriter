...
- **local** (default): Uses OpenAI models with local PostgreSQL
...
The HelpDeskMCPServer should be running alongside the main application:
...
# In a new terminal, start the main application (with MCP client enabled)
