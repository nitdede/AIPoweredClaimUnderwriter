...
public class GlobalExceptionHandler {
     ...
     * Handle generic ClaimUnderwriterException
     */
    @ExceptionHandler(SensitiveKeywordException.class)
    public ResponseEntity<ErrorResponse> handleSensitiveKeywordException(
            SensitiveKeywordException ex, WebRequest request) {
        logger.error("Sensitive Keyword exception: {}", ex.getMessage(), ex);
