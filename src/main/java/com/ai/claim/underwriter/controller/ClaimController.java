...
public class ClaimController {
    ...
    public ClaimProcessingResult processClaimFile(@RequestPart("file") MultipartFile file, @RequestParam String policyNumber, String patientName) throws IOException {
