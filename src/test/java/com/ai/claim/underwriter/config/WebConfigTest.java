...
class WebConfigTest {
    ...
    void testExcludeStaticResourcePaths() {
        ...
        // Assert
        verify(interceptorRegistration).excludePathPatterns("/static/**", "/css/**", "/js/**", "/images/**");
    }
    ...
    void testInterceptorConfigurationOrder() {
        ...
        inOrder.verify(interceptorRegistration).excludePathPatterns("/static/**", "/css/**", "/js/**", "/images/**");
    }
